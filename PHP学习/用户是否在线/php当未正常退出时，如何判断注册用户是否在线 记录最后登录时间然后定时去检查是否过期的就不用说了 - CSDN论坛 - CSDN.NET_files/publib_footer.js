...
document.write("</dl>");
document.write("</div>");
document.write('<script id="noticeScript" type="text/javascript"  btnId="header_notice_num" wrapId="note1" count="5" subcount="5" src="' + protocol + '//' +


'csdnimg.cn' +

'/rabbit/notev2/js/notify.js?f926d64"></script>');

var head = document.getElementsByTagName('head')[0]
	, s, ss = [
		protocol + '//csdnimg.cn/pubfooter/js/tracking.js?r1125'
		, protocol + '//csdnimg.cn/rabbit/tracking-ad/main.js?r1125'
	]
	;
