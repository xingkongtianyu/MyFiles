...
var scrolltotop={
	...
	controlHTML: '<img src="/images/ok_1.png" style="width:48;height:61;"  onmouseover="huan();" onmouseout="yuan();" id="niutop">', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
...
function huan(){
	var niutop= document.getElementById('niutop');
	niutop.src='../images/ok_2.png';
}
function yuan(){
	var niutop= document.getElementById('niutop');
	niutop.src='../images/ok_1.png';
}
