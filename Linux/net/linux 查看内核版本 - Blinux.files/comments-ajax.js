...
var edit_mode = '0', // 再編輯模式 ( '1'=開; '0'=不開 )
		...
		txt1 = '<div id="loading" style="display:none; background:url(' + pic_sb + ') no-repeat left; padding-left:20px;">正在提交, 请稍候...</div>',
...
// show comment
		...
		$('#new_comm_' + num).show(500);  //原为.fadeIn(4000)；
